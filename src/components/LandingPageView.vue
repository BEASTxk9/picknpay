...
<a id="shop" href="/products">Login & Register is currently Unavalible. Click here to go to Shop</a>
      ...
      <div class="row">
        ...
        <div id="log" class="col-6">
          <form v-if="logshow" @submit.prevent="signUp" method="POST">
            <input type="text" v-model="email" placeholder="Email" /><br />
            <input type="password" v-model="userpassword" placeholder="Password" />
            <br />
            <button to="/products" type="submit">Log in</button>
          </form>
        </div>
        ...
        <div id="reg" class="col-6">
          <form
            v-if="regshow" @submit.prevent="signUp" method="POST"
          >
            <!-- firstname -->
            <input
              type="text"
